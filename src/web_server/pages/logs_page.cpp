...
void handleLogsPage()
{
    ...
    html += "        row += '<td>' + log.tankLrgTemp.toFixed(1) + ' °C</td>';\n";
    html += "        row += '<td>' + log.tankSmlTemp.toFixed(1) + ' °C</td>';\n";
    html += "        row += '<td>' + log.roomTemp.toFixed(1) + ' °C</td>';\n";
    html += "        row += '<td>' + log.roomHumidity.toFixed(0) + ' %</td>';\n";
    html += "        row += '<td>' + log.roomPressure.toFixed(1) + ' мм рт.ст.</td>';\n";
    ...
    html += "        row += '<td>' + log.currentValue.toFixed(2) + '</td>';\n";
    html += "        row += '<td>' + log.previousAvg.toFixed(2) + '</td>';\n";
    html += "        row += '<td>' + log.changePercent.toFixed(2) + ' %</td>';\n";
